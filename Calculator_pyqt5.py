...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(400, 400, 325, 470)
        ...
        self.div_int = QPushButton('//', self)
        self.div_int.resize(50, 50)
        self.div_int.move(225, 155)
        ...
        self.mult2 = QPushButton('X²', self)
        self.mult2.resize(50, 50)
        self.mult2.move(225, 210)
        ...
        self.mult3 = QPushButton('Y³', self)
        self.mult3.resize(50, 50)
        self.mult3.move(225, 265)
        ...
        self.div_int.clicked.connect(self.div_int_1)
        self.mult2.clicked.connect(self.mult2_)
        self.mult3.clicked.connect(self.mult3_)
    ...
    def ravno(self):
        ...
        if self.operation == '+':
            ...
            self.rezult = self.operand_1**3

        elif self.operation == '%':
            self.rezult = (float(self.label.text))/100
